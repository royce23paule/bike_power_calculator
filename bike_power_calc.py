...
def main() -> None:
    ...
    st.caption("Streamlit-Migration der bestehenden Desktop-App – Version 0.8")
    ...
    with st.sidebar:
        ...
        st.divider()
        st.success("Version 0.8: Version 0.8: Challenge Roth Defaults + Beispiel-GPX.")
    ...
    with file_col1:
        ...
        if route_path:
            ...
            st.info(f"Standardstrecke aktiv: {config.get('GPX/FIT Datei')}")
